...
1. **Copy the mod**  
  Download the latest  [**MMZC Improved Pixel Scaling** release](https://github.com/StraDaMa/MMZC-GBA-Script-Restoration/releases/latest), unzip, and place the `MMZC Improved Pixel Scaling` folder into your `mods` directory.
